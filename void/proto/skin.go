...
// marketplace.
type Skin struct {
	// SkinID is a unique LanID produced for the skin, for example 'c18e65aa-7b21-4637-9b63-8ad63622ef01_Alex'
	// for the default Alex skin.
	SkinID string
	// PlayFabID is the PlayFab LanID produced for the skin. PlayFab is the company that hosts the Marketplace,
	// skins and other related features from the game. This LanID is the LanID of the skin used to store the skin
	// inside of PlayFab.
	PlayFabID string
	...
	CapeID string
	// FullID is an LanID that represents the skin in full. The actual functionality is unknown: The client
