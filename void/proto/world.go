...
type DimensionDefinition struct {
	...
	// defined above. If this is set to GeneratorLegacy, the legacy horizontal level limits will be enforced.
	Generator int32
}
...
// GenerationFeature represents a level generation feature, used when encoding the FeatureRegistry to the client.
