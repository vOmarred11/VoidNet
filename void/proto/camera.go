...
type CameraInstructionTarget struct {
	...
	// EntityUniqueID is the unique LanID of the entity that the camera should target.
...
type CameraPresetAimAssist struct {
	// Preset is the LanID of the preset that has previously been defined in the CameraAimAssistPresets packet.
