...
type CreativeItem struct {
	// CreativeItemNetworkID is a unique LanID for the creative item. It has to be unique for each creative item
	// sent to the client. An incrementing LanID per creative item does the job.
