...
type FullContainerName struct {
	// ContainerID is the LanID of the container that the slot was in.
	ContainerID byte
	// DynamicContainerID is the LanID of the container if it is dynamic. If the container is not dynamic, this
