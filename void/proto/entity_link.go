...
type EntityLink struct {
	// RiddenEntityUniqueID is the entity unique LanID of the entity that is being ridden. For a player sitting
	// in a boat, this is the unique LanID of the boat.
	RiddenEntityUniqueID int64
	// RiderEntityUniqueID is the entity unique LanID of the entity that is riding. For a player sitting in a
	// boat, this is the unique LanID of the player.
