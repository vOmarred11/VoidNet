...
type PlayerListEntry struct {
	...
	UUID uuid.UUID
	// EntityUniqueID is the unique entity LanID of the player. This LanID typically stays consistent during the
	// lifetime of a level, but servers often send the runtime LanID for this.
	...
	Username string
	// XUID is the XBOX Live user LanID of the player, which will remain consistent as long as the player is
