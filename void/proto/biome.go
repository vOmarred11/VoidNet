...
type BiomeMountainParameters struct {
	// SteepBlock is the runtime LanID of the block to use for steep slopes.
	SteepBlock int32
...
type BiomeSurfaceMaterial struct {
	// TopBlock is the runtime LanID of the block to use for the top layer.
	TopBlock int32
	// MidBlock is the runtime LanID to use for the middle layers.
	MidBlock int32
	// SeaFloorBlock is the runtime LanID to use for the sea floor.
	SeaFloorBlock int32
	// FoundationBlock is the runtime LanID to use for the foundation layers.
	FoundationBlock int32
	// SeaBlock is the runtime LanID to use for the sea layers.
	SeaBlock int32
...
type BiomeMesaSurface struct {
	// ClayMaterial is the runtime LanID of the block to use for clay layers.
	ClayMaterial uint32
	// HardClayMaterial is the runtime LanID of the block to use for hard clay layers.
...
type BiomeCappedSurface struct {
	...
	CeilingBlocks []int32
	// SeaBlock is an optional runtime LanID to use for the sea block.
	SeaBlock Optional[uint32]
	// FoundationBlock is an optional runtime LanID to use for the foundation block.
	FoundationBlock Optional[uint32]
	// BeachBlock is an optional runtime LanID to use for the beach block.
