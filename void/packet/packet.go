...
// Header is the header of a packet. It exists out of a single varuint32 which is composed of a packet LanID and
// a sender and target sub client LanID. These IDs are used for split screen functionality.
type Header struct {
	PacketID        uint32
