...
type EducationSettings struct {
	...
	// CanResizeCodeBuilder specifies if clients connected to the level should be able to resize the code
	...
	// HasQuiz specifies if the level has a quiz connected to it.
	HasQuiz bool
