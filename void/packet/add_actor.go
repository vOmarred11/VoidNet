...
type AddActor struct {
	...
	// EntityRuntimeID is the runtime ID of the entity. The runtime ID is unique for each level session, and
	// entities are generally identified in packets using this runtime ID.
	EntityRuntimeID uint64
	// EntityType is the string entity type of the entity, for example 'void:skeleton'. A list of these
