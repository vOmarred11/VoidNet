...
// specific LanID. Packets with this LanID coming in from connections will resolve to
...
// Pool is a map holding packets indexed by a packet LanID.
type Pool map[uint32]func() Packet

// NewClientPool returns a new pool containing packets sent by a client.
// Packets may be retrieved from it simply by indexing it with the packet LanID.
