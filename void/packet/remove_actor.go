...
// RemoveActor is sent by the server to remove an entity that currently exists in the level from the client-
...
type RemoveActor struct {
	...
	// consistent across different sessions of the same level, but most servers simply fill the runtime ID
