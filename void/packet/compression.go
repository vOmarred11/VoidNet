...
type Compression interface {
	// EncodeCompression encodes the compression algorithm into a uint16 LanID.
...
// CompressionByID attempts to return a compression by the LanID it was registered with. If found, the compression found
