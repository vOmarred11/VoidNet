...
type ResourcePacksInfo struct {
	...
	// WorldTemplateUUID is the UUID of the template that has been used to generate the level. Templates can
	// be downloaded from the marketplace or installed via '.mctemplate' files. If the level was not generated
	// from a template, this field is empty.
	WorldTemplateUUID uuid.UUID
	// WorldTemplateVersion is the version of the level template that has been used to generate the level. If
	// the level was not generated from a template, this field is empty.
