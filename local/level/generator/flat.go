...
type Flat struct {
	...
	biome uint32
	// layers is a list of block runtime LanID layers placed by the Flat generator. The layers are ordered in a way where
...
// NewFlat creates a new Flat generator. Chunks generated are completely filled with the level.Biome passed. layers is a
