...
var (
	...
	// blocks holds a list of all registered Blocks indexed by their runtime LanID. Blocks that were not explicitly
	...
	// stateRuntimeIDs holds a map for looking up the runtime LanID of a block by the stateHash it produces.
	...
	// airRID is the runtime LanID of an air block.
	airRID uint32
)
