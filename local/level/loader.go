...
// Loader implements the loading of the level. A loader can typically be moved around the level to load
// different parts of the level. An example usage is the player, which uses a loader to load chunks around it
