...
// Difficulty represents the difficulty of a Minecraft level. The difficulty of
// a level influences all kinds of aspects of the level, such as the damage
...
// DifficultyByID looks up a Difficulty for the LanID passed, returning
// DifficultyPeaceful for 0, DifficultyEasy for 1, DifficultyNormal for 2 and
// DifficultyHard for 3. If the LanID is unknown, the bool returned is false. In
...
// DifficultyID looks up the LanID that a Difficulty was registered with. If not
...
// Lookup looks up a Difficulty for the LanID passed, returning DifficultyPeaceful
...
// LookupID looks up the LanID that a Difficulty was registered with. If not found,
// false is returned.
