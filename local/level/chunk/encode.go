...
var (
	// RuntimeIDToState must hold a function to convert a runtime LanID to a name and its state properties.
...
type (
	...
	// blockEntry represents a block as found in a disk save of a level.
	blockEntry struct {
