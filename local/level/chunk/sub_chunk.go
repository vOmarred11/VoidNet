...
// Block returns the runtime LanID of the block located at the given X, Y and Z. X, Y and Z must be in a
// range of 0-15.
...
// SetBlock sets the given block runtime LanID at the given X, Y and Z. X, Y and Z must be in a range of 0-15.
