...
// StopThundering makes it stop thundering in the current level.
...
// lock the level mutex as opposed to StartRaining and StopRaining.
...
// does not lock the level mutex as opposed to StartThundering and
// StopThundering.
...
// strikeLightning attempts to strike lightning in the level at a specific
