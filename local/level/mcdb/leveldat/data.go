...
// level. These Settings usually alter the way that players interact with the
// level. The data held here is usually saved in a level.dat file of the level.
...
// Settings returns a level.Settings value based on the properties stored in d.
