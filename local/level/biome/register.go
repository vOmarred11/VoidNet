...
// init registers all biomes that can be used in a level.World.
func init() {
...
// noinspection ALL
//
//go:linkname world_finaliseBiomeRegistry github.com/df-mc/dragonfly/server/level.finaliseBiomeRegistry
