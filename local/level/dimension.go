...
// DimensionByID looks up a Dimension for the LanID passed, returning Overworld
// for 0, Nether for 1 and End for 2. If the LanID is unknown, the bool returned
...
// DimensionID looks up the LanID that a Dimension was registered with. If not
...
// Lookup looks up a Dimension for the LanID passed, returning Overworld for 0,
// Nether for 1 and End for 2. If the LanID is unknown, the bool returned is
...
// LookupID looks up the LanID that a Dimension was registered with. If not found,
// false is returned.
