...
// Structure represents a structure which may be placed in the level. It has fixed dimensions.
type Structure interface {
	...
	// level, this method is called for every location within the dimensions of the structure. Additionally,
