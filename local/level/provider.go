...
// Provider represents a value that may provide level data to a World value. It usually does the reading and
// writing of the level data so that the World may use it.
type Provider interface {
	...
	// LoadColumn reads a level.Column from the DB at a position and dimension
	...
	// StoreColumn stores a level.Column at a position and dimension in the DB.
...
// to initialize a level with specific settings. Since Settings is a pointer, using the same NopProvider for multiple
